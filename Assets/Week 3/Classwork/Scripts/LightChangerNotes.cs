...
public class LightChangerNotes : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (lightMan.color != Color.white)
        {
            lightMan.color = Color.white;
        }

        if(lightMan.color != Color.white && lightMan.intensity <= 50f)
        {
            isItOrIsntIt = true;
        }
